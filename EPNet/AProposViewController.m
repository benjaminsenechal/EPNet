...
- (void)viewDidLoad
{
    ...
    [textDescription setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:14]];
    ...
    [labelSite setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:17]];
    ...
    [labelContact setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:24]];
    ...
    [textAdress setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:14]];
    ...
    [labelTelNumber setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:14]];
    ...
    [labelSuivezNous setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:24]];
    ...
    [labelTwitter setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:20]];
